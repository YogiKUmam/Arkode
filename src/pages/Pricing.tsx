  ...
  return (
    <>
      <Seo
        ...
        description="Model paket Arkode Labs untuk website, landing page, web application, dan maintenance."
      />

      <section className="py-16 sm:py-24">
        <div className="container-shell max-w-4xl">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-accent">Engagement model</p>
          <h1 className="mt-4 text-4xl font-semibold leading-tight text-navy sm:text-5xl">
            Paket layanan dan timeline yang dimulai dari scope yang jelas.
          </h1>
